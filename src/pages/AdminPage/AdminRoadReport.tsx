...
import AdminRoadReportForm from "../../components/AdminPageForm/AdminRoadReportForm";

// 임시 데이터
const tempRoadReportreports = [
  {
    id: "id1",
  ...
  },
  {
    id: "id4",
    address: "서울시 종로구 광화문",
    roadContext: "광화문 광장 집회로 인한 차량 통제",
  ...
  },
  {
    id: "id6",
    address: "서울시 용산구 이태원",
    roadContext: "이태원 메인 스트리트 행사로 인한 차량 우회",
  ...
  },
  {
    ...
    roadContext: "건대입구역 앞 택시 승강장 이전 작업",
  ...
  },
  {
    id: "id10",
    address: "서울시 노원구 상계동",
    roadContext: "상계동 로터리 교통 신호 시스템 업그레이드",
...
const AdminRoadReport = () => {
  return (
    <div>
      <AdminRoadReportForm data={tempRoadReportreports} />
    </div>
  );
};

export default AdminRoadReport;
